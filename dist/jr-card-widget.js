...
(function(document) {
    ...
    function render(resume) {
        ...
        container.innerHTML = window.jr_tmpl['jr-card-template']({
            ...
            // social_links: getSocialLinks(resume)
        });
